...
def main():
   ...
   query = spark.readStream.format("kafka")\
      .option("kafka.bootstrap.servers", "rc1b-16hcqe8dqm1aekq9.mdb.yandexcloud.net:9091") \
   ...
   df.write.format("text").save("s3a://dataproc-bucket-kraev/kafka-read-stream-output")
